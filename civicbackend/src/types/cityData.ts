...
// Rich complaint/city shape used by src/data/cityData.ts (demo/seed data).
// Kept separate from ../types/complaint.ts (StoredComplaint), which is the
// slimmer shape used for Firestore + embeddings.
